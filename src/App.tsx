...
export default function App() {
  ...
  const adminEmails = [
    ...
    "tesouraria@gmail.com",
    "paidesanto@gmail.com",
  ];
  ...
  const [telaAtiva, setTelaAtiva] = useState<
    "dashboard" | "filhos" | "financeiro" | "perfil"
  >("dashboard");
  ...
  async function carregarDados() {
    ...
    if (mesReferencia !== "TODOS")
      qFin = qFin.eq("mes_referencia", mesReferencia);
    const { data: fin } = await qFin;
    let b = 0,
      s = 0;
    fin?.forEach((i) =>
      i.tipo === "ENTRADA" ? (b += i.valor) : (s += i.valor),
    );
  ...
  async function toggleExpandir(filho: any) {
    ...
    if (filho.data_entrada) {
      ...
      while (
        dataIter <= dataAtual ||
        (dataIter.getMonth() === dataAtual.getMonth() &&
          dataIter.getFullYear() === dataAtual.getFullYear())
      ) {
        ...
        histGerado.push({
          ...
          dt: pagou ? pagou.data_pagamento : null,
        });
    ...
    <div className="app-layout">
      <aside className="sidebar">
        <div className="brand-container">
          ...
          <h2>TTZ GESTÃO</h2>
          <h5>
            Terreiro de Umbanda <br /> Baiana Terezinha e Zé Pelintra
          </h5>
        </div>
        <nav>
          <button
          ...
          <button
            className={`nav-item ${telaAtiva === "filhos" ? "active" : ""}`}
            onClick={() => {
              setTelaAtiva("filhos");
          ...
          <button
            className={`nav-item ${telaAtiva === "financeiro" ? "active" : ""}`}
      ...
      <main className="main-content">
          ...
          <div className="header-actions">
            {telaAtiva === "filhos" && isAdmin && (
              <button
                ...
                onClick={() => {
                  setMostrarFormFilho(!mostrarFormFilho);
          ...
          <div style={{ width: "100%" }}>
            ...
            <div className="dashboard-grid">
              <div className="table-container">
                <h3>
                  <AlertCircle size={22} color="var(--warning)" /> Mensalidades
                  Pendentes
                </h3>
                    ...
                    <tbody>
                      {mesReferencia === "TODOS" ? (
                        <tr>
                          ...
                          >
                            Filtre por um mês específico acima.
                          </td>
                        </tr>
                      ) : pendentes.length === 0 ? (
                        <tr>
              ...
              <div className="table-container">
                <h3>
                  <Clock size={22} color="var(--secondary)" /> Entradas Recentes
                </h3>
                <div className="table-responsive">
                  <table>
                    <thead>
                  ...
                  >
                    <h3 style={{ margin: 0 }}>
                      <Users
                        size={22}
                        color={
                          abaInativos ? "var(--text-muted)" : "var(--primary)"
                        }
                      />
                      {abaInativos
                    ...
                    <tbody>
                      {filhosExibidos.length === 0 ? (
                        <tr>
                          ...
                          >
                            Nenhum membro encontrado na lista de{" "}
                            {abaInativos ? "Inativos" : "Ativos"}.
                          </td>
                        </tr>
                      ) : (
                                    ...
                                    {f.ativo !== false ? (
                                      <>
                                        ...
                                        <button
                                          onClick={() => {
                                            if (
                                              window.confirm(
                                                `Desligar ${f.nome} da corrente? O histórico financeiro será mantido.`,
                                              )
                                            ) {
                                              supabase
                                                .from("filhos")
                                      ...
                                      <button
                                        onClick={() => {
                                          if (
                                            window.confirm(
                                              `Reativar ${f.nome} na corrente de trabalho?`,
                                            )
                                          ) {
                                            supabase
                                              .from("filhos")
                                    ...
                                    <div className="crm-grid">
                                      <div className="crm-profile">
                                        ...
                                        {f.ativo === false ? (
                                          ...
                                          <span className="badge-status badge-isento">
                                                ...
                                                (h, i) => (
                                                  ...
                                                  >
                                                    ...
                                                    <td data-label="Status">
                                                      ...
                                                      {h.status ===
                                                        "ADIANTADO" && (
                                                        <span className="badge-status badge-adiantado">
                                                          <FastForward
                                                            size={14}
                                                          />{" "}
                                                          ADIANTADO
                                                    ...
                                                    <td data-label="Data Pgto">
                                                      {formatarData(h.dt)}
                                                    </td>
                                                  </tr>
                                                ),
                                              )}
                                              {historicoMensalidades.length ===
                                                0 && (
                                                <tr>
                                                  <td
                                                    colSpan={3}
        ...
        {telaAtiva === "financeiro" && (
          <LancamentoFinanceiro mesFiltro={mesReferencia} isAdmin={isAdmin} />
        )}
